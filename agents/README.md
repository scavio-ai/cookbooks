...
- **`pricewar.py`** -- Amazon vs Walmart arbitrage finder for resellers. Built with the [Scavio retail search APIs](https://scavio.dev) -- [free 250 credits/mo](https://dashboard.scavio.dev).
...
- **`momentum-radar.py`** -- cross-platform momentum score (Google + YouTube + TikTok + Reddit). Built on the [Scavio search API](https://scavio.dev) -- [free 250 credits/mo](https://dashboard.scavio.dev).
