"""
Capterra product detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/capterra/product.
...
Usage:
  python capterra_product_scraper.py "asana"
"""
...
API_URL = "https://api.scavio.dev/api/v1/capterra/product"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python capterra_product_scraper.py 'asana'", file=sys.stderr)
        raise SystemExit(1)
    slug = sys.argv[1]
    data = scrape(slug)
