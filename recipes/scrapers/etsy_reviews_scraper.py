"""
Etsy shop reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/etsy/reviews.
...
Usage:
  python etsy_reviews_scraper.py "StonehousePotteryOH"
"""
...
API_URL = "https://api.scavio.dev/api/v1/etsy/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python etsy_reviews_scraper.py 'StonehousePotteryOH'", file=sys.stderr)
        raise SystemExit(1)
    shop = sys.argv[1]
    data = scrape(shop)
