"""
Meta Ad Library search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/meta-ads/search.
...
Usage:
  python metaads_search_scraper.py "nike"
"""
...
API_URL = "https://api.scavio.dev/api/v1/meta-ads/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python metaads_search_scraper.py 'nike'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
