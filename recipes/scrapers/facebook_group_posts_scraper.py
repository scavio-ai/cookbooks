"""
Facebook group posts scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/facebook/group/posts.
...
Usage:
  python facebook_group_posts_scraper.py "https://www.facebook.com/groups/developers"
"""
...
API_URL = "https://api.scavio.dev/api/v1/facebook/group/posts"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python facebook_group_posts_scraper.py 'https://www.facebook.com/groups/developers'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
