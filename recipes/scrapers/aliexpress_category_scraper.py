"""
AliExpress category scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/aliexpress/category.
...
Usage:
  python aliexpress_category_scraper.py "44"
"""
...
API_URL = "https://api.scavio.dev/api/v1/aliexpress/category"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python aliexpress_category_scraper.py '44'", file=sys.stderr)
        raise SystemExit(1)
