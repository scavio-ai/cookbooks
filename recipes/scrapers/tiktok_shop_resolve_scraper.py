"""
TikTok Shop URL resolver scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/tiktok-shop/resolve.
...
Usage:
  python tiktok_shop_resolve_scraper.py "https://www.tiktok.com/@shop/product/1729508362826743"
"""
...
API_URL = "https://api.scavio.dev/api/v1/tiktok-shop/resolve"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tiktok_shop_resolve_scraper.py 'https://www.tiktok.com/@shop/product/1729508362826743'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
