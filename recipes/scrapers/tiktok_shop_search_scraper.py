"""
TikTok Shop search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/tiktok-shop/search.
...
Usage:
  python tiktok_shop_search_scraper.py "phone case"
"""
...
API_URL = "https://api.scavio.dev/api/v1/tiktok-shop/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tiktok_shop_search_scraper.py 'phone case'", file=sys.stderr)
        raise SystemExit(1)
    search = sys.argv[1]
    data = scrape(search)
