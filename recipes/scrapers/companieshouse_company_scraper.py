"""
Companies House company detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/companieshouse/company.
...
Usage:
  python companieshouse_company_scraper.py "09397466"
"""
...
API_URL = "https://api.scavio.dev/api/v1/companieshouse/company"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python companieshouse_company_scraper.py '09397466'", file=sys.stderr)
        raise SystemExit(1)
