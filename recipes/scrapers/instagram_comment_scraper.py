"""
Instagram comment scraper -- pure Scavio API scraper.

Scrapes comments on an Instagram post by shortcode,
straight from the Scavio API endpoint POST /api/v1/instagram/post/comments. No SDK, no
...
Usage:
  python instagram_comment_scraper.py "DZpQwxqimz2"
"""
...
API_URL = "https://api.scavio.dev/api/v1/instagram/post/comments"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python instagram_comment_scraper.py <shortcode>", file=sys.stderr)
        raise SystemExit(1)
