"""
Instagram followings scraper -- pure Scavio API scraper.

Scrapes accounts an Instagram user follows,
straight from the Scavio API endpoint POST /api/v1/instagram/user/followings. No SDK, no
...
Usage:
  python instagram_followings_scraper.py "nike"
"""
...
API_URL = "https://api.scavio.dev/api/v1/instagram/user/followings"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python instagram_followings_scraper.py <username>", file=sys.stderr)
        raise SystemExit(1)
    username = sys.argv[1]
