"""
TikTok followings scraper -- pure Scavio API scraper.

Scrapes accounts a TikTok user follows, by sec_user_id,
straight from the Scavio API endpoint POST /api/v1/tiktok/user/followings. No SDK, no
...
Usage:
  python tiktok_followings_scraper.py "MS4wL..."
"""
...
API_URL = "https://api.scavio.dev/api/v1/tiktok/user/followings"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tiktok_followings_scraper.py <sec_user_id>", file=sys.stderr)
        raise SystemExit(1)
