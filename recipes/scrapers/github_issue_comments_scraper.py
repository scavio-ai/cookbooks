"""
GitHub issue comments scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/github/issue/comments.
...
Usage:
  python github_issue_comments_scraper.py "facebook/react#37330"
"""
...
API_URL = "https://api.scavio.dev/api/v1/github/issue/comments"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python github_issue_comments_scraper.py 'facebook/react#37330'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
