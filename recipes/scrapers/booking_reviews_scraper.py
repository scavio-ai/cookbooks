"""
Booking.com hotel reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/booking/reviews.
...
Usage:
  python booking_reviews_scraper.py "1234567"
"""
...
API_URL = "https://api.scavio.dev/api/v1/booking/reviews"


def scrape(hotel: str) -> dict:
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python booking_reviews_scraper.py '1234567'", file=sys.stderr)
        raise SystemExit(1)
    hotel = sys.argv[1]
    data = scrape(hotel)
