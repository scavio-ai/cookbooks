"""
Pinterest profile scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/pinterest/profile.
...
Usage:
  python pinterest_profile_scraper.py "pinterest"
"""
...
API_URL = "https://api.scavio.dev/api/v1/pinterest/profile"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python pinterest_profile_scraper.py 'pinterest'", file=sys.stderr)
        raise SystemExit(1)
    username = sys.argv[1]
