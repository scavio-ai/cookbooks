"""
Threads profile scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/threads/profile.
...
Usage:
  python threads_profile_scraper.py "zuck"
"""
...
API_URL = "https://api.scavio.dev/api/v1/threads/profile"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python threads_profile_scraper.py 'zuck'", file=sys.stderr)
        raise SystemExit(1)
    username = sys.argv[1]
