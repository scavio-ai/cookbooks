"""
LinkedIn job detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/linkedin/job.
...
Usage:
  python linkedin_job_scraper.py "4415427228"
"""
...
API_URL = "https://api.scavio.dev/api/v1/linkedin/job"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python linkedin_job_scraper.py '4415427228'", file=sys.stderr)
        raise SystemExit(1)
    job_id = sys.argv[1]
    data = scrape(job_id)
