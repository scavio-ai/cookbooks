"""
Apple App Store search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/appstore/search.
...
Usage:
  python appstore_search_scraper.py "fitness tracker"
"""
...
API_URL = "https://api.scavio.dev/api/v1/appstore/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python appstore_search_scraper.py 'fitness tracker'", file=sys.stderr)
        raise SystemExit(1)
    term = sys.argv[1]
    data = scrape(term)
