"""
Pinterest search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/pinterest/search.
...
Usage:
  python pinterest_search_scraper.py "home decor ideas"
"""
...
API_URL = "https://api.scavio.dev/api/v1/pinterest/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python pinterest_search_scraper.py 'home decor ideas'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
