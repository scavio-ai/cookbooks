"""
Pinterest URL save counts scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/pinterest/url-stats.
...
Usage:
  python pinterest_url_stats_scraper.py "https://www.nytimes.com"
"""
...
API_URL = "https://api.scavio.dev/api/v1/pinterest/url-stats"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python pinterest_url_stats_scraper.py 'https://www.nytimes.com'", file=sys.stderr)
        raise SystemExit(1)
