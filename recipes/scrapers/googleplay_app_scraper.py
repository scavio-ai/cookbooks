"""
Google Play app detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/googleplay/app.
...
Usage:
  python googleplay_app_scraper.py "com.google.android.apps.maps"
"""
...
API_URL = "https://api.scavio.dev/api/v1/googleplay/app"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python googleplay_app_scraper.py 'com.google.android.apps.maps'", file=sys.stderr)
        raise SystemExit(1)
    app_id = sys.argv[1]
    data = scrape(app_id)
