"""
GitHub user email OSINT scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/github/user/email.
...
Usage:
  python github_user_email_scraper.py "torvalds"
"""
...
API_URL = "https://api.scavio.dev/api/v1/github/user/email"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python github_user_email_scraper.py 'torvalds'", file=sys.stderr)
        raise SystemExit(1)
    handle = sys.argv[1]
    data = scrape(handle)
