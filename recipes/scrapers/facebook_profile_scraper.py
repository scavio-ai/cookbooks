"""
Facebook page profile scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/facebook/profile.
...
Usage:
  python facebook_profile_scraper.py "https://www.facebook.com/nike"
"""
...
API_URL = "https://api.scavio.dev/api/v1/facebook/profile"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python facebook_profile_scraper.py 'https://www.facebook.com/nike'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
