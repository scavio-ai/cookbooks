"""
LinkedIn post comments scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/linkedin/post/comments.
...
Usage:
  python linkedin_post_comments_scraper.py "7488618410256523265"
"""
...
API_URL = "https://api.scavio.dev/api/v1/linkedin/post/comments"


def scrape(post_id: str) -> dict:
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python linkedin_post_comments_scraper.py '7488618410256523265'", file=sys.stderr)
        raise SystemExit(1)
    post_id = sys.argv[1]
    data = scrape(post_id)
