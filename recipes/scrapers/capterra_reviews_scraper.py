"""
Capterra product reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/capterra/reviews.
...
Usage:
  python capterra_reviews_scraper.py "asana"
"""
...
API_URL = "https://api.scavio.dev/api/v1/capterra/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python capterra_reviews_scraper.py 'asana'", file=sys.stderr)
        raise SystemExit(1)
    slug = sys.argv[1]
    data = scrape(slug)
