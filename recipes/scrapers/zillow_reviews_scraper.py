"""
Zillow agent reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/zillow/reviews.
...
Usage:
  python zillow_reviews_scraper.py "ericbramlett"
"""
...
API_URL = "https://api.scavio.dev/api/v1/zillow/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python zillow_reviews_scraper.py 'ericbramlett'", file=sys.stderr)
        raise SystemExit(1)
