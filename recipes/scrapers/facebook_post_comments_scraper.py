"""
Facebook post comments scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/facebook/post/comments.
...
Usage:
  python facebook_post_comments_scraper.py "https://www.facebook.com/nike/posts/1234567890"
"""
...
API_URL = "https://api.scavio.dev/api/v1/facebook/post/comments"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python facebook_post_comments_scraper.py 'https://www.facebook.com/nike/posts/1234567890'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
