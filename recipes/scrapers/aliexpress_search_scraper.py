"""
AliExpress search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/aliexpress/search.
...
Usage:
  python aliexpress_search_scraper.py "wireless earbuds"
"""
...
API_URL = "https://api.scavio.dev/api/v1/aliexpress/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python aliexpress_search_scraper.py 'wireless earbuds'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
