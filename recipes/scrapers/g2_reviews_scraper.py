"""
G2 product reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/g2/reviews.
...
Usage:
  python g2_reviews_scraper.py "salesforce-crm"
"""
...
API_URL = "https://api.scavio.dev/api/v1/g2/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python g2_reviews_scraper.py 'salesforce-crm'", file=sys.stderr)
        raise SystemExit(1)
    slug = sys.argv[1]
    data = scrape(slug)
