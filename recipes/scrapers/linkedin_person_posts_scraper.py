"""
LinkedIn person posts scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/linkedin/person/posts.
...
Usage:
  python linkedin_person_posts_scraper.py "williamhgates"
"""
...
API_URL = "https://api.scavio.dev/api/v1/linkedin/person/posts"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python linkedin_person_posts_scraper.py 'williamhgates'", file=sys.stderr)
        raise SystemExit(1)
    username = sys.argv[1]
