"""
LinkedIn ad library search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/linkedin/ads/search.
...
Usage:
  python linkedin_ads_search_scraper.py "nike"
"""
...
API_URL = "https://api.scavio.dev/api/v1/linkedin/ads/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python linkedin_ads_search_scraper.py 'nike'", file=sys.stderr)
        raise SystemExit(1)
    keyword = sys.argv[1]
    data = scrape(keyword)
