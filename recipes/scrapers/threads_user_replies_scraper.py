"""
Threads user replies scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/threads/user/replies.
...
Usage:
  python threads_user_replies_scraper.py "zuck"
"""
...
API_URL = "https://api.scavio.dev/api/v1/threads/user/replies"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python threads_user_replies_scraper.py 'zuck'", file=sys.stderr)
        raise SystemExit(1)
    username = sys.argv[1]
