"""
eBay search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/ebay/search.
...
Usage:
  python ebay_search_scraper.py "wireless headphones"
"""
...
API_URL = "https://api.scavio.dev/api/v1/ebay/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python ebay_search_scraper.py 'wireless headphones'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
