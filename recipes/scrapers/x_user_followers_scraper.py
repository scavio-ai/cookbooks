"""
X (Twitter) user followers scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/x/user/followers.
...
Usage:
  python x_user_followers_scraper.py "elonmusk"
"""
...
API_URL = "https://api.scavio.dev/api/v1/x/user/followers"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python x_user_followers_scraper.py 'elonmusk'", file=sys.stderr)
        raise SystemExit(1)
