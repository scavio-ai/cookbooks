"""
Booking.com hotel detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/booking/hotel.
...
Usage:
  python booking_hotel_scraper.py "1234567"
"""
...
API_URL = "https://api.scavio.dev/api/v1/booking/hotel"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python booking_hotel_scraper.py '1234567'", file=sys.stderr)
        raise SystemExit(1)
    hotel = sys.argv[1]
    data = scrape(hotel)
