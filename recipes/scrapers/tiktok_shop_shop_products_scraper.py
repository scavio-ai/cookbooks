"""
TikTok Shop seller products scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/tiktok-shop/shop/products.
...
Usage:
  python tiktok_shop_shop_products_scraper.py "7487475316940456"
"""
...
API_URL = "https://api.scavio.dev/api/v1/tiktok-shop/shop/products"


def scrape(shop_id: str) -> dict:
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tiktok_shop_shop_products_scraper.py '7487475316940456'", file=sys.stderr)
        raise SystemExit(1)
    shop_id = sys.argv[1]
    data = scrape(shop_id)
