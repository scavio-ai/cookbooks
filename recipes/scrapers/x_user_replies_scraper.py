"""
X (Twitter) user replies scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/x/user/replies.
...
Usage:
  python x_user_replies_scraper.py "elonmusk"
"""
...
API_URL = "https://api.scavio.dev/api/v1/x/user/replies"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python x_user_replies_scraper.py 'elonmusk'", file=sys.stderr)
        raise SystemExit(1)
