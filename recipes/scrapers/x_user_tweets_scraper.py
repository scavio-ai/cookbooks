"""
X (Twitter) user tweets scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/x/user/tweets.
...
Usage:
  python x_user_tweets_scraper.py "elonmusk"
"""
...
API_URL = "https://api.scavio.dev/api/v1/x/user/tweets"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python x_user_tweets_scraper.py 'elonmusk'", file=sys.stderr)
        raise SystemExit(1)
