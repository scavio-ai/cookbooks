"""
Facebook reel/video scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/facebook/reel.
...
Usage:
  python facebook_reel_scraper.py "https://www.facebook.com/reel/1234567890"
"""
...
API_URL = "https://api.scavio.dev/api/v1/facebook/reel"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python facebook_reel_scraper.py 'https://www.facebook.com/reel/1234567890'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
