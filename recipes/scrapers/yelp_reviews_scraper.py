"""
Yelp business reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/yelp/reviews.
...
Usage:
  python yelp_reviews_scraper.py "starbucks-austin"
"""
...
API_URL = "https://api.scavio.dev/api/v1/yelp/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python yelp_reviews_scraper.py 'starbucks-austin'", file=sys.stderr)
        raise SystemExit(1)
