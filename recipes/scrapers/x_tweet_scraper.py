"""
X (Twitter) tweet detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/x/tweet.
...
Usage:
  python x_tweet_scraper.py "1808168603721650364"
"""
...
API_URL = "https://api.scavio.dev/api/v1/x/tweet"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python x_tweet_scraper.py '1808168603721650364'", file=sys.stderr)
        raise SystemExit(1)
    tweet_id = sys.argv[1]
