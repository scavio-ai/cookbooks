"""
Glassdoor company lookup scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/glassdoor/companies.
...
Usage:
  python glassdoor_companies_scraper.py "Nike"
"""
...
API_URL = "https://api.scavio.dev/api/v1/glassdoor/companies"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python glassdoor_companies_scraper.py 'Nike'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
