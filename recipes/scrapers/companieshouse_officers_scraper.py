"""
Companies House officers scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/companieshouse/officers.
...
Usage:
  python companieshouse_officers_scraper.py "09397466"
"""
...
API_URL = "https://api.scavio.dev/api/v1/companieshouse/officers"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python companieshouse_officers_scraper.py '09397466'", file=sys.stderr)
        raise SystemExit(1)
