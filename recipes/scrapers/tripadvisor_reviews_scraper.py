"""
TripAdvisor reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/tripadvisor/reviews.
...
Usage:
  python tripadvisor_reviews_scraper.py "30196"
"""
...
API_URL = "https://api.scavio.dev/api/v1/tripadvisor/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tripadvisor_reviews_scraper.py '30196'", file=sys.stderr)
        raise SystemExit(1)
