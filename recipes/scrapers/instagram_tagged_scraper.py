"""
Instagram tagged posts scraper -- pure Scavio API scraper.

Scrapes posts an Instagram user is tagged in,
straight from the Scavio API endpoint POST /api/v1/instagram/user/tagged. No SDK, no
...
Usage:
  python instagram_tagged_scraper.py "nike"
"""
...
API_URL = "https://api.scavio.dev/api/v1/instagram/user/tagged"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python instagram_tagged_scraper.py <username>", file=sys.stderr)
        raise SystemExit(1)
    username = sys.argv[1]
