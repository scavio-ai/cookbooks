"""
Facebook event scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/facebook/event.
...
Usage:
  python facebook_event_scraper.py "https://www.facebook.com/events/1234567890"
"""
...
API_URL = "https://api.scavio.dev/api/v1/facebook/event"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python facebook_event_scraper.py 'https://www.facebook.com/events/1234567890'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
