"""
Target category scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/target/category.
...
Usage:
  python target_category_scraper.py "5xtg6"
"""
...
API_URL = "https://api.scavio.dev/api/v1/target/category"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python target_category_scraper.py '5xtg6'", file=sys.stderr)
        raise SystemExit(1)
