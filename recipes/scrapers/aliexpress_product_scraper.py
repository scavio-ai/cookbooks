"""
AliExpress product detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/aliexpress/product.
...
Usage:
  python aliexpress_product_scraper.py "1005006861677164"
"""
...
API_URL = "https://api.scavio.dev/api/v1/aliexpress/product"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python aliexpress_product_scraper.py '1005006861677164'", file=sys.stderr)
        raise SystemExit(1)
