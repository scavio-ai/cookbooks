"""
SEC EDGAR company facts scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/sec/facts.
...
Usage:
  python sec_facts_scraper.py "AAPL"
"""
...
API_URL = "https://api.scavio.dev/api/v1/sec/facts"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python sec_facts_scraper.py 'AAPL'", file=sys.stderr)
        raise SystemExit(1)
    ticker = sys.argv[1]
    data = scrape(ticker)
