"""
TikTok Shop product detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/tiktok-shop/product.
...
Usage:
  python tiktok_shop_product_scraper.py "1729508362826743"
"""
...
API_URL = "https://api.scavio.dev/api/v1/tiktok-shop/product"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tiktok_shop_product_scraper.py '1729508362826743'", file=sys.stderr)
        raise SystemExit(1)
