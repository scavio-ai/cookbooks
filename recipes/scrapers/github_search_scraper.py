"""
GitHub search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/github/search.
...
Usage:
  python github_search_scraper.py "machine learning"
"""
...
API_URL = "https://api.scavio.dev/api/v1/github/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python github_search_scraper.py 'machine learning'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
