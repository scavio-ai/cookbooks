"""
Facebook group profile scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/facebook/group.
...
Usage:
  python facebook_group_scraper.py "https://www.facebook.com/groups/developers"
"""
...
API_URL = "https://api.scavio.dev/api/v1/facebook/group"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python facebook_group_scraper.py 'https://www.facebook.com/groups/developers'", file=sys.stderr)
        raise SystemExit(1)
    url = sys.argv[1]
    data = scrape(url)
