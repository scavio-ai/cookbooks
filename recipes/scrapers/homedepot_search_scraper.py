"""
Home Depot search scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/homedepot/search.
...
Usage:
  python homedepot_search_scraper.py "cordless drill"
"""
...
API_URL = "https://api.scavio.dev/api/v1/homedepot/search"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python homedepot_search_scraper.py 'cordless drill'", file=sys.stderr)
        raise SystemExit(1)
    query = sys.argv[1]
    data = scrape(query)
