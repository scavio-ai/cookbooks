"""
Glassdoor company reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/glassdoor/reviews.
...
Usage:
  python glassdoor_reviews_scraper.py "1699"
"""
...
API_URL = "https://api.scavio.dev/api/v1/glassdoor/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python glassdoor_reviews_scraper.py '1699'", file=sys.stderr)
        raise SystemExit(1)
