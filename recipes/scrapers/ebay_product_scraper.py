"""
eBay product detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/ebay/product.
...
Usage:
  python ebay_product_scraper.py "168591664725"
"""
...
API_URL = "https://api.scavio.dev/api/v1/ebay/product"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python ebay_product_scraper.py '168591664725'", file=sys.stderr)
        raise SystemExit(1)
    item_id = sys.argv[1]
    data = scrape(item_id)
