"""
Target product detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/target/product.
...
Usage:
  python target_product_scraper.py "1010453160"
"""
...
API_URL = "https://api.scavio.dev/api/v1/target/product"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python target_product_scraper.py '1010453160'", file=sys.stderr)
        raise SystemExit(1)
    tcin = sys.argv[1]
    data = scrape(tcin)
