"""
Airbnb listing detail scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/airbnb/listing.
...
Usage:
  python airbnb_listing_scraper.py "1704452615554844556"
"""
...
API_URL = "https://api.scavio.dev/api/v1/airbnb/listing"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python airbnb_listing_scraper.py '1704452615554844556'", file=sys.stderr)
        raise SystemExit(1)
