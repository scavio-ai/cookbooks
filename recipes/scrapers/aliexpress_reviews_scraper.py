"""
AliExpress product reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/aliexpress/reviews.
...
Usage:
  python aliexpress_reviews_scraper.py "1005006861677164"
"""
...
API_URL = "https://api.scavio.dev/api/v1/aliexpress/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python aliexpress_reviews_scraper.py '1005006861677164'", file=sys.stderr)
        raise SystemExit(1)
