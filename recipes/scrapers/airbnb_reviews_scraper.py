"""
Airbnb listing reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/airbnb/reviews.
...
Usage:
  python airbnb_reviews_scraper.py "1704452615554844556"
"""
...
API_URL = "https://api.scavio.dev/api/v1/airbnb/reviews"


def scrape(listing_id: str) -> dict:
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python airbnb_reviews_scraper.py '1704452615554844556'", file=sys.stderr)
        raise SystemExit(1)
    listing_id = sys.argv[1]
    data = scrape(listing_id)
