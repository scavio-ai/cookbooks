"""
Apple App Store app reviews scraper -- pure Scavio API scraper.

Scrapes data straight from the Scavio API endpoint POST /api/v1/appstore/reviews.
...
Usage:
  python appstore_reviews_scraper.py "544007664"
"""
...
API_URL = "https://api.scavio.dev/api/v1/appstore/reviews"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python appstore_reviews_scraper.py '544007664'", file=sys.stderr)
        raise SystemExit(1)
    app_id = sys.argv[1]
    data = scrape(app_id)
